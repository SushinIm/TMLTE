...
<body>
	...
	<div id="section">
		<form name="payAirFrm" action="payAir" method="get">
			<input type="hidden" name="prodnum" value="${prodAir.air_num}" />
			<div>
				<ul>
			...
			<div id="seats">
				...
				<ul class="seatFrm">
					<li>
						등급 : <select name="grade1" class="1" onchange="seatList(this)">
					...
					<li>
						<input type="text" name="raname" readonly />
...
<script type="text/javascript">
    ...
    function formAdd(){
    	...
    	$('div#seats > ul').removeAttr('class');
   	 	...
   	 	$('div#seats > ul:last select[name=grade1]').attr('class', cnt);
    ...
    function seatList(obj){
    	var seatcnt = $(obj).attr('class');
    	$.ajax({
    		type:'get',
    		url:'./outputSeat',
    		data:{grade : $(obj).val(), prodnum:'${prodAir.air_num}'},
			dataType:'json',
    		success:function(data){
    			$('.row'+seatcnt).html(data);
    		},
