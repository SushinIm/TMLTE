	...
	<div>
		<form name="hotelInsertFrm" method="post"
			...
			<div>
				...
				<br /> 호텔명(영어)<input type="text" name="egname" /> <br /> 
				...
				연락처&nbsp<select name="phonefirst">
					<option value="010">010</option>
					<option value="011">011</option>
					<option value="017">017</option>
					<option value="018">018</option>
					<option value="032">032</option>
				</select> - <input type="text" name="phonecenter" /> - <input type="text" name="phonelast" /><br/>
				주소<input type="text" name="addr"/>
			</div>
			<input type="button" value="추가" id="omg"/>
			<div id="frm">
			객실명 <input type="text" name="r_name0"/> 객실번호 <input type="text" name="r_num0"/> 
			객실가격 <input type="text" name="r_price0"/> 최대인원 <input type="text" name="r_person0"/>
			</div>
			<div>
